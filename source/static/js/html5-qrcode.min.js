...
function Version(d, a, c, b, e, g) {
    ...
    this.buildFunctionPattern = function () {
        var e = this.DimensionForVersion, b = new BitMatrix(e);
        b.setRegion(0, 0, 9, 9);
        b.setRegion(e - 8, 0, 8, 9);
        b.setRegion(0, e - 8, 9, 8);
        for (var c = this.alignmentPatternCenters.length, a = 0; a < c; a++)for (var g = this.alignmentPatternCenters[a] - 2, d = 0; d < c; d++)0 == a && (0 == d || d == c - 1) || a == c - 1 && 0 == d || b.setRegion(this.alignmentPatternCenters[d] - 2, g, 5, 5);
...
(function (d) {
    d.fn.html5_qrcode = function (a, c, b) {
        var e = this.height(), g = this.width();
        null == e && (e = 250);
        null == g && (g = 300);
